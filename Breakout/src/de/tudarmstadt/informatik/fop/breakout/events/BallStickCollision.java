...
public class BallStickCollision extends Event implements GameParameters{
	...
	protected boolean performAction(GameContainer arg0, StateBasedGame arg1, int arg2) {
		if (a.getEntityManager().hasEntity(arg1.getCurrentStateID(), STICK_ID) && a.getEntityManager().hasEntity(arg1.getCurrentStateID(), BALL_ID)) {
			return a.getEntityManager().getEntity(arg1.getCurrentStateID(), STICK_ID).collides(a.getEntityManager().getEntity(arg1.getCurrentStateID(), BALL_ID));
		} else
			return false;
	}
